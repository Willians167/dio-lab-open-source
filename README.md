...
4. Caso aconteça esse tipo de erro "fatal: detected dubious ownership in repository at 'D:/Programação/DIO/desafio-add-contribuição-opensource/dio-lab-open-source' " use o esse comando para trata-lo: 'git config --global --add safe.directory '
